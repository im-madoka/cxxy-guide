...
public:
    ...
    void eat() {
        std::cout << this->name << " 在吃饭" << std::endl;
    }

    void is_alive() {
        if (this->alive) {
            std::cout << this->name << " 是活的" << std::endl;
        } else {
            std::cout << this->name << " 已经死了" << std::endl;
        }
    }
};
...
public:
    ...
    void bark() {
        std::cout << this->name << " 在汪汪叫" << std::endl;
    }
...
public:
    ...
    void meow() {
        std::cout << this->name << " 在喵喵叫" << std::endl;
    }
};
